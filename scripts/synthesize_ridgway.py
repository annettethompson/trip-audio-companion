"""
Synthesize the Ridgway / Orvis Hot Springs episode from script markdown files.
Usage: python scripts/synthesize_ridgway.py
"""
import asyncio
import re
import sys
...
EPISODE_TITLE = "The San Juan Volcanic Field: Ridgway, Orvis Hot Springs, and the Mountains Built by Fire"
EPISODE_SLUG = "ridgway"

SCRIPTS_DIR = Path("outputs/ridgway_scripts")
SEGMENTS_DIR = Path("outputs/audio_segments_ridgway")
...
CHAPTERS = [
    ("00_intro.md", "Introduction: The Arrival Hook"),
    ("01_san_juan_volcanism.md", "The San Juan Volcanic Field"),
    ("02_the_drive.md", "Reading the Road: Glenwood to Ridgway"),
    ("03_uncompahgre_plateau.md", "The Ancient Foundation"),
    ("04_ute_nation.md", "The Tabeguache People"),
    ("05_orvis_hot_springs.md", "The Science of the Soak"),
    ("06_ridgway_and_ouray.md", "The Mountain Towns"),
    ("07_mining_history.md", "Fire, Ore, and Fortune"),
    ("08_plants_ridgway.md", "Plants of the Mountain Transition"),
    ("09_wildlife_ridgway.md", "Animals of the San Juan Foothills"),
    ("10_dallas_divide.md", "What to Notice on the Drive"),
    ("11_1923_moment.md", "1923: The Last of the Pack Strings"),
    ("12_come_back_for_this.md", "Trails, Thrills, and Tables"),
]
...
async def main():
    console.print("[bold cyan]Trip Audio Companion -- TTS Synthesis (Ridgway Episode)[/bold cyan]")
    ...
    if not segment_paths:
        console.print("[red]No segments synthesized. Check outputs/ridgway_scripts/ directory.[/red]")
        return
